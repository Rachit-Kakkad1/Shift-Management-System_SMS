...
// Theme configuration per role (Matched with Root.jsx 'Brown Light' theme)
const themes = {
  admin: {
    id: "admin",
    label: "Admin",
    ...
    colors: {
      ...
      ringFocus: "focus:ring-stone-500/20",
      ...
      <div className="flex-1 bg-white/80 rounded-xl shadow-sm border border-stone-200/50 p-4 flex flex-col gap-3">
         ...
         {[1,2,3].map(i => (
           <div key={i} className="flex-1 bg-stone-50/50 rounded-lg border border-stone-100/50 flex items-center px-4 gap-3">
              ...
              <div className="w-12 h-4 bg-amber-100 rounded-full border border-amber-200"></div>
           </div>
         ))}
      </div>
    </div>
...
function EmployeeMockup() {
  return (
    <div className="w-full h-full p-6 flex flex-col gap-4 font-sans">
      {/* Profile Bar */}
      <div className="flex justify-between items-center bg-white/80 p-4 rounded-2xl shadow-sm border border-amber-100/50">
         <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-amber-400 to-orange-400 p-0.5">
               <div className="w-full h-full bg-white rounded-full flex items-center justify-center text-xs font-bold text-amber-600">ME</div>
            </div>
            <div>
      ...
      {/* Calendar View */}
      <div className="flex-1 bg-white/80 rounded-2xl shadow-sm border border-amber-100/50 overflow-hidden flex flex-col p-4 gap-3">
         {/* Days */}
         <div className="flex justify-between px-2 text-[10px] font-bold text-stone-400 mb-2">
            <span>MON</span><span>TUE</span><span>WED</span><span className="text-amber-600">THU</span><span>FRI</span>
         </div>
         <div className="flex-1 bg-amber-50/30 rounded-xl border border-amber-100/30 relative p-3 flex flex-col gap-2 overflow-hidden">
            {/* Shifts */}
            <div className="h-16 bg-white rounded-xl shadow-sm border border-amber-100 flex items-center px-3 gap-3 transform hover:scale-[1.02] transition-transform cursor-pointer">
               <div className="w-10 h-10 rounded-lg bg-amber-100 flex flex-col items-center justify-center text-amber-700">
            ...
            <div className="h-16 bg-white rounded-xl shadow-sm border border-amber-100 flex items-center px-3 gap-3 transform hover:scale-[1.02] transition-transform cursor-pointer opacity-75">
...
function HRMockup() {
  return (
    <div className="w-full h-full p-6 flex flex-col gap-4 font-sans">
       {/* Search Bar */}
       <div className="bg-white/80 p-3 rounded-xl shadow-sm border border-orange-100/50 flex items-center gap-2">
          <Search className="w-4 h-4 text-stone-400" />
          <div className="h-3 w-32 bg-stone-100 rounded-full"></div>
       </div>
       
       <div className="flex gap-4">
         <div className="flex-1 bg-gradient-to-br from-orange-400 to-rose-500 rounded-xl p-4 text-white shadow-lg relative overflow-hidden group">
            <Users className="absolute right-[-10px] bottom-[-10px] w-20 h-20 text-white/10 group-hover:scale-110 transition-transform" />
            <div className="text-xs font-medium text-orange-100">Total Staff</div>
            <div className="text-3xl font-bold mt-1">248</div>
         </div>
         <div className="w-1/3 bg-white/80 rounded-xl p-4 shadow-sm border border-orange-100/50 flex flex-col justify-center items-center gap-1">
       ...
       {/* List */}
       <div className="flex-1 bg-white/80 rounded-xl shadow-sm border border-orange-100/50 p-4 flex flex-col gap-3">
          <div className="text-xs font-bold text-stone-800 mb-1">Recent Activity</div>
          {[1,2,3].map(i => (
             <div key={i} className="flex items-center gap-3">
                ...
                <div className="text-[10px] font-medium text-stone-400">2h ago</div>
             </div>
          ))}
       </div>
    </div>
